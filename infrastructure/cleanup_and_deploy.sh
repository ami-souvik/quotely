...
REGION="ap-south-1"
TABLE_NAME="QuotelyCore-v10" # Updated name
BUCKET_NAME="quotely-quotes-v10" # Updated name
REPO_NAME="quotely-serverless-v10" # Updated name
...
IMAGE_NAME="quotely-serverless-v10" # Updated name
